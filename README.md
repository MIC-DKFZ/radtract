...
```
cd existing_repo
git remote add origin https://git.dkfz.de/mic/personal/group6/neuro/radiomic-tractometry.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.dkfz.de/mic/personal/group6/neuro/radiomic-tractometry/-/settings/integrations)
